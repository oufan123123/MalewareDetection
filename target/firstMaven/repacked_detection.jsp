        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-header">输入良性apk路径</div>
                    <!--Card content-->
                    <div class="card-body" class="form-control mb-4" style="display: inline-block">



                        <input id='good' type="text" class="form-control mb-4" placeholder="良性apk路径">
        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-md-12 mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-header">输入恶意apk路径</div>
                    <!--Card content-->
